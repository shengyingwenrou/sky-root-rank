...
<template>
    <div class="wdg-btn"
         ...
         :accessible="true"
         :aria-label="text">
        <text class="btn-text" :style="mrTextStyle">{{text||'确认'}}</text>
    </div>
</template>

<script>
  import {STYLE_MAP, TEXT_STYLE_MAP, BUTTON_STYLE_MAP, TEXT_FONTSIZE_STYLE_MAP} from './WdgButtonType';
  ...
  export default {
    ...
    methods: {
      onClicked(e) {
        ...
        this.$emit('wdgButtonClicked', {e, type, disabled});
      }
    }
  }
</script>
