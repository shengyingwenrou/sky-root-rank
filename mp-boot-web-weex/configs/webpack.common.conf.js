...
const weexEntry = {
  ...
  // TODO 配置生成多个单页js
  //'RechargeTimeByMoney': helper.root('entry/RechargeTimeByMoney.js'),
  //'RechargeTimeByBeans': helper.root('entry/RechargeTimeByBeans.js'),
  'RechargeTime': helper.root('entry/RechargeTime.js'),
  'RechargeChangeProject': helper.root('entry/RechargeChangeProject.js'),
  'RechargeCoupon': helper.root('entry/RechargeCoupon.js'),
  'RechargeCouponUsed': helper.root('entry/RechargeCouponUsed.js'),
  'RechargeRecord': helper.root('entry/RechargeRecord.js'),
  'PopUpAd': helper.root('entry/PopUpAd.js')
}
