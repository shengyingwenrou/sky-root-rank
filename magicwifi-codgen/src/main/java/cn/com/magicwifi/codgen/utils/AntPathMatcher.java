...
public class AntPathMatcher  {
	...
	private static class AntPatternComparator implements Comparator<String> {
		...
		public int compare(String pattern1, String pattern2) {
			...
			int wildCardCount1 = CodgenUtil.countOccurrencesOf(pattern1, "*");
			int wildCardCount2 = CodgenUtil.countOccurrencesOf(pattern2, "*");
			...
			int bracketCount1 = CodgenUtil.countOccurrencesOf(pattern1, "{");
			int bracketCount2 = CodgenUtil.countOccurrencesOf(pattern2, "{");
